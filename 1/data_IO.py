...
if __name__ == '__main__':
    ...
    # mlab.show()
    # 下面的代码是用来查看自制的东西的
    sample = np.load("E:\\PythonProject11\\data128×312\\train\\joint\\0001_160.npy")
    print(sample.shape)
    ...
    '''samples = np.load("F:\\GAN\\1111\\learned-models5555\\3dGAN-tf2\\3dGAN\\3dGAN-results.pickle170.npy")
    print(samples.shape)
    chair = samples[0]
